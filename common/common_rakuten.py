...
def get_basic_point(driver):
    try:
        point=driver.find_element(By.CSS_SELECTOR, "#rakutenLimitedId_cart > tbody > tr:nth-child(1) > div:nth-child(4) > div > div:nth-child(4) > div > div > ul.point-summary__campaign___14I4T.point-summary__multiplier-up___3wYrU.point-up > li:nth-child(2)").get_attribute('innerHTML')
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    try:
                        point=driver.find_element(By.CSS_SELECTOR, "#rakutenLimitedId_cart > tbody > tr:nth-child(1) > div:nth-child(4) > div > div:nth-child(4) > div > div > ul.point-summary__campaign___14I4T.point-summary__rebate___AO-bR.point-superdeal > li:nth-child(2)").get_attribute('innerHTML')
